...
//        findViewById<View>(R.id.categoryRoomForRent).setOnClickListener {
//            // Handle click for "Room for Rent" category
//            navigateToAllRentalPropertiesFragment("Room for Rent")
//        }
//
//        findViewById<View>(R.id.categoryBedSpaceForRent).setOnClickListener {
//            // Handle click for "Bed Space for Rent" category
//            navigateToAllRentalPropertiesFragment("Bed Space for Rent")
//        }
//
//        findViewById<View>(R.id.categoryApartmentForRent).setOnClickListener {
//            // Handle click for "Room for Rent" category
//            navigateToAllRentalPropertiesFragment("Room for Rent")
//        }
//
//        findViewById<View>(R.id.categoryCondoForRent).setOnClickListener {
//            // Handle click for "Bed Space for Rent" category
//            navigateToAllRentalPropertiesFragment("Bed Space for Rent")
//        }
